...
if (!class_exists('QRcode', false)) {
	...
	class QRcode {
		 ...
		 * @internal param array $bitstream original bitstream
		 */
		 ...
		 * @param bool|int $replLen length of the repl string
		 * @return array srctab
		 */
		 ...
		 * @return array frame
		 * @internal param int $width width
		 */
		 ...
		 * @param int $width width
		 * @return array frame
		 * @internal param array $fram frame
		 */
